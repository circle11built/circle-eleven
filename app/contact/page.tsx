...
export default function Contact() {
  return (
    <section className="mt-28 mb-16 lg:grid grid-cols-2 gap-36 px-5 lg:px-36">
      <div>
        <h1 className="text-3xl xl:text-6xl mb-6 font-semibold">
          Request a <span className="text-red-900">quote</span>
        </h1>

        <p className="mb-10 max-w-2xl text-lg">
          Got questions or want to request a custom order? Reach out to us anytime — our team is ready to provide the support and guidance
          you need.
        </p>
